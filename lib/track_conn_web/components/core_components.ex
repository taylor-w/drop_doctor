defmodule TrackConnWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(TrackConnWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(TrackConnWeb.Gettext, "errors", msg, opts)
    # end
