defmodule DropDoctor.Probes.Reach do
  @moduledoc """
  ...
  which `DropDoctor.Aggregate` smooths exactly like a ping.
  """

  @behaviour DropDoctor.Probe

  alias DropDoctor.Probes.Ping
  ...
  defp tcp_fallback(anchors, opts) do
    ...
    connect = opts[:tcp] || fn host -> DropDoctor.Net.tcp_connect(host, ports, @tcp_timeout) end
