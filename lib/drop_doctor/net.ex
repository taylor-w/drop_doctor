defmodule DropDoctor.Net do
  ...
  `DropDoctor.Probes.Ping.parse/2` is.
  ...
  reachability probe (`DropDoctor.Probes.Reach`) and the continuous TCP sampler
  (`DropDoctor.Probes.TcpStream`) so the socket contract can't drift between them.
