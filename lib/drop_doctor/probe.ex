defmodule DropDoctor.Probe do
  ...
  def default_registry do
    %{
      ping: DropDoctor.Probes.Ping,
      reach: DropDoctor.Probes.Reach,
      dns: DropDoctor.Probes.Dns,
      http: DropDoctor.Probes.Http
    }
  end

  @doc "The active registry, allowing tests/config to inject fakes."
  def registry do
    Application.get_env(:drop_doctor, :probes, default_registry())
  end
end
