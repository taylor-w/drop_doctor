defmodule DropDoctorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(DropDoctorWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(DropDoctorWeb.Gettext, "errors", msg, opts)
    # end
